...
//"let" os a keyword that allows you to declare a variable
...
function setup() { //runs once at starup
  ...
  circleSizw = width*0.35; // sets circleSize variable in relation to width
...
function draw() {
  ...
  stroke("rgba(203, 193, 218, 1)");
  fill("rgba(246, 198, 219, 1)");

  strokeWeight(5);
  //noStrole(); gets rid of the stroke completely
  ...
  fill("#f5d2aaff");// colors can also be denoted in hex format
